(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["history-history-module"], {
    ...
    function uZ(module, __webpack_exports__, __webpack_require__) {
      ...
      var _component_record_record_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    /***/
    function M4g1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Z2Lo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var HistoryPage = /*#__PURE__*/function () {
        function HistoryPage(api, modalController) {
        ...
        _createClass(HistoryPage, [{
              ...
              case 'wk':
                {
                  ...
                  var _iterator = _createForOfIteratorHelper(this.api.allSignatures),
                      _step;
              ...
              case 'mm':
                {
                  ...
                  var _iterator2 = _createForOfIteratorHelper(this.api.allSignatures),
                      _step2;
                  ...
                  try {
                    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                      ...
                      if (_item.timeStamp >= _date.getTime()) {
                        this.filters.push(_item);
                      }
                    }
                  } catch (err) {
                    _iterator2.e(err);
              ...
              case 'year':
                {
                  ...
                  _date2.setDate(_date2.getDate() - 365);

                  var _iterator3 = _createForOfIteratorHelper(this.api.allSignatures),
                      _step3;
                  ...
                  try {
                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                      ...
                      if (_item2.timeStamp >= _date2.getTime()) {
                        this.filters.push(_item2);
                      }
                    }
                  } catch (err) {
                    _iterator3.e(err);
          ...
          key: "openModal",
          value: function openModal(details) {
    ...
    /***/
    function kofg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function nQSQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
