...
/* harmony import */ var _profile_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./profile-routing.module */ "v+7O");
...
let ProfilePage = class ProfilePage {
    constructor(fb, auth, language) {
        ...
        this.formGroup = fb.group({
            ...
            collegeYearControl: [
                '',
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].max(5)],
            ],
            collegeYearControlSi: [
                '',
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].max(3)],
            ],
            hospitalControl: [''],
        });
    }
    ...
    getUserAttributes() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.user = yield this.auth.getCurrentUserAttributes();
